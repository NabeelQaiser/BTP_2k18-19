...
BEGIN
    ...
    BEGIN
        ...
        IF v_delivery_status_id IS NULL THEN
		      get_delivery_status(a_delivery_status, v_delivery_status_id);
		      get_delivery_status1(a_delivery_status, v_delivery_status_id);
		      get_delivery_status2(a_delivery_status, v_delivery_status_id);
		    ELSIF v_delivery_status_id IS  NOT NULL THEN
		      get_delivery_status1(a_delivery_status, v_delivery_status_id);
		      get_delivery_status2(a_delivery_status, v_delivery_status_id);
		    ELSIF v_delivery_status_id IS  NOT NULL THEN
		      get_delivery_status1(a_delivery_status, v_delivery_status_id);
