clients:: pesel_c:NOT_NULL, first_name:NULL, last_name:NULL, telephone: NOT_NULL, COUNT_star:not_null
...
rooms:: room_id:NOT_NULL, capacity:NOT_NULL, price_per_day:NOT_NULL, SUM_price_per_day:NOT_NULL
